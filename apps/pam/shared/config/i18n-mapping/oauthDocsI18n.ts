...
export const oauthDocsI18n = Object.freeze({
  ...
  sectionArchitecture: i18nKeys.PAGE_DOCS_OAUTH_SECTION_ARCHITECTURE,
  architectureBody: i18nKeys.PAGE_DOCS_OAUTH_ARCHITECTURE_BODY,
  sectionDemo: i18nKeys.PAGE_DOCS_OAUTH_SECTION_DEMO,
  demoBody: i18nKeys.PAGE_DOCS_OAUTH_DEMO_BODY,
  ...
  endpointVerify: i18nKeys.PAGE_DOCS_OAUTH_ENDPOINT_VERIFY,
  endpointVerifyDesc: i18nKeys.PAGE_DOCS_OAUTH_ENDPOINT_VERIFY_DESC,
