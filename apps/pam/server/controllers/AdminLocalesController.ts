...
import {
  ...
  pamAdminLocaleCreateSchema,
  pamAdminLocaleUpdateSchema,
...
export class AdminLocalesController {
  ...
  public async create(body: unknown): Promise<PamAdminLocaleItem | null> {
    const parsed = pamAdminLocaleCreateSchema.parse(body);
  ...
  public async update(body: unknown): Promise<{ ok: true }> {
    const parsed = pamAdminLocaleUpdateSchema.parse(body);
