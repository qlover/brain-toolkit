...
/**
 * @description 你没有项目 "{{slug}}" 的写权限（需为项目拥有者或团队可写成员）。
 * @localZh 你没有项目 "{{slug}}" 的写权限（需为项目拥有者或团队可写成员）。
 * @localEn You do not have write access to project "{{slug}}" (project owner or team writer required).
 */
